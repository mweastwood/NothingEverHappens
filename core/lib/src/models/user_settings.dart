...
class UserSettings {
  ...
  factory UserSettings.fromJson(Map<String, dynamic> json, {DateTime? now}) {
    final effectiveNow = now ?? CoreClock.now;
    ...
    final acknowledgedMissedTaskCommunications =
        _pruneAcknowledgedCommunications(parsedAcknowledgedComms, effectiveNow);
  ...
  bool operator ==(Object other) {
    ...
    return hoursAvailable == other.hoursAvailable &&
        ...
        const MapEquality()
            .equals(defaultDailyCapacity, other.defaultDailyCapacity) &&
        const MapEquality()
            .equals(dailyCapacityOverrides, other.dailyCapacityOverrides) &&
