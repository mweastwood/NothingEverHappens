...
import 'package:nothing_ever_happens/widgets/monthly_completion_relative_scheduling_widget.dart';
...
void main() {
  group('MonthlyCompletionRelativeSchedulingWidget', () {
        ...
        buildTestableWidget(
          child: Scaffold(
            body: SingleChildScrollView(
              child: MonthlyCompletionRelativeSchedulingWidget(
                interval: 2,
                onIntervalChanged: (_) {},
    ...
    testGoldens('MonthlyCompletionRelativeSchedulingWidget renders correctly', (
      tester,
    ) async {
      final builder = GoldenBuilder.grid(columns: 1, widthToHeightRatio: 0.8)
        ..addScenario(
          'MonthlyCompletion Default',
          Material(
            child: Padding(
      ...
      await screenMatchesGolden(
        tester,
        'monthly_completion_relative_scheduling_widget_golden',
      );
    });
  });
}
