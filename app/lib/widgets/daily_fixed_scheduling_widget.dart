...
class DailyFixedSchedulingWidget extends StatefulWidget {
  ...
  const DailyFixedSchedulingWidget({
    super.key,
  ...
  @override
  State<DailyFixedSchedulingWidget> createState() =>
      _DailyFixedSchedulingWidgetState();
}

class _DailyFixedSchedulingWidgetState
    extends State<DailyFixedSchedulingWidget> {
  ...
  @override
  void didUpdateWidget(DailyFixedSchedulingWidget oldWidget) {
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Expanded(
              child: DateStepper(
                key: const Key('daily_fixed_date_stepper'),
                date: dt,
        ...
        const SizedBox(height: 8),
        RelativeTimeWidget(
          key: const Key('daily_fixed_start_relative_time_picker'),
        ...
        const SizedBox(height: 8),
        RelativeTimeWidget(
          key: const Key('daily_fixed_due_relative_time_picker'),
          constraint: RelativeTimeConstraint.unconstrained,
        ...
        if (widget.showNotification) ...[
          ...
          if (notificationEnabled) ...[
            ...
            const SizedBox(height: 8),
            RelativeTimeWidget(
              key: const Key('daily_fixed_notification_relative_time_picker'),
              constraint: RelativeTimeConstraint.unconstrained,
        ...
        if (widget.showMissedPolicy &&
          ...
          MissedOccurrencePolicySelector(
            key: const Key('daily_fixed_missed_policy'),
