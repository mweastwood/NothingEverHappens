            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isMocked ? Colors.orangeAccent : Theme.of(context).colorScheme.primaryContainer,
                ...
                child: Material(
                  ...
                  child: InkWell(
                    ...
                    child: Tooltip(
                      ...
                      child: Icon(
                        Icons.av_timer,
                        color: isMocked ? Colors.black87 : Theme.of(context).colorScheme.onPrimaryContainer,
                      ),
                    ),
                  ),
                ),
                        ...
                        Row(
                          ...
                          children: [
                            ElevatedButton(
                              ...
                              onPressed: () => AppClock.advanceTime(const Duration(days: 1)),
                              child: const Text('+1 Day', style: TextStyle(fontWeight: FontWeight.bold)),
                            ),
...
class TimeMachineDashboard extends StatelessWidget {
  ...
  Widget _buildQuickAdvanceButton(BuildContext context, String label, Duration duration) {
  ...
  Widget _buildDSTPresetButton(BuildContext context, String label, DateTime targetTime) {
          ...
          child: Padding(
            ...
            child: SingleChildScrollView(
              child: Column(
                  ...
                  child: Row(
                    ...
                    children: [
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text('Simulated Date & Time', style: TextStyle(fontSize: 11, color: Colors.grey)),
                ...
                if (isMocked) ...[
                  const Text('Quick Time Advance', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
                  ...
                  GridView.count(
                    ...
                    mainAxisSpacing: 8,
                    children: [
                      _buildQuickAdvanceButton(context, '+1 Hour', const Duration(hours: 1)),
                      _buildQuickAdvanceButton(context, '+12 Hours', const Duration(hours: 12)),
                      _buildQuickAdvanceButton(context, '+1 Day', const Duration(days: 1)),
                      _buildQuickAdvanceButton(context, '+1 Week', const Duration(days: 7)),
                    ],
                  ),
                  const SizedBox(height: 24),

                  // DST Presets
                  const Text('🚀 DST Fast-Travel Presets', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 8),
                  Column(
                    children: [
                      SizedBox(
